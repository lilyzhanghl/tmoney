 ...
 * @Description: 初始化driver, 封装webdriver和element的一些操作
 * @Author: zhzh.yin
...
public class InitializeDriver {
    ...
    /* private static InitializeDriver initDriver;
     private InitializeDriver(PageObjectModel model) {
         this.driver = getDriver(model);
     }
     public static InitializeDriver getInstance(PageObjectModel model){
         if(initDriver==null){
             initDriver = new InitializeDriver(model);
         }
         return initDriver;
     }*/
    static final WebDriver getDriver(String path) {
        if (driver == null) {
